...
public class MainMaze : MonoBehaviour
{
    ...
    {   //https://infiniteproductionsblog.wordpress.com/maze-generation-in-csharp/
        ...
        maze1.dumpMaze();
        Byte[,] blockmaze = maze1.LineToBlock(); // Converti en array

        int lenMinus1 = blockmaze.GetLength(1) - 1;
        blockmaze[0, UnityEngine.Random.Range(1,y)] = 0; // Entree
        blockmaze[lenMinus1, UnityEngine.Random.Range(1,y)] = 0; // Sorti
